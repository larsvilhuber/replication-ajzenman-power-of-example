...
///////// change to lower proportion
replace Romper =1 if inlist(co01,1)
...
////// change to lower proportion
replace Tranza =1 if inlist(co03,1)
...
replace Confiable =0 if inlist(co05,1)
...
//////////////////////  CHANGE to p90
replace Robar = 1 if rg09_11 > p90
...
//////////////////////  CHANGE to p90
replace NotReturn = 1 if complemento > nrp90
...
cap log close
log using "Tables/Table4-robustness1.txt", text replace
*** TABLE IV
