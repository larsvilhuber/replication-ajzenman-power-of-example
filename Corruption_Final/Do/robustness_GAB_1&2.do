...
use "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Hogares\c_portad.dta", clear

merge 1:1 folio using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Hogares\c_cv.dta",
drop _m

merge 1:1 folio using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Hogares\c_cvo.dta",
drop _m

merge 1:1 folio using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Hogares\c_ne.dta",
drop _m

merge 1:1 folio using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Hogares\c_rc.dta",
drop _m

merge 1:m folio using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Hogares\Fechas.dta",
drop _m

**** 2009: individuals (id:folio or pid_link)

merge 1:m folio using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiia_ee.dta",
keep if _m ==3
drop _m

merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiia_ah.dta",
keep if _m ==3
drop _m

merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiia_ed.dta",
keep if _m ==3
drop _m

merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiia_iin.dta",
keep if _m ==3
drop _m

merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiia_tb.dta",
keep if _m ==3
drop _m

merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiib_rg.dta",
keep if _m !=2
drop _m

merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiib_co.dta",
keep if _m !=2
drop _m


merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiia_mg.dta",
keep if _m !=2
drop _m

merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiia_ata.dta",
keep if _m !=2
drop _m

merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiib_sm.dta",
drop _m

merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiib_pr.dta",
drop _m

merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiia_vli.dta",
drop _m

merge 1:1 pid_link using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\2009\Individuos\iiia_shi.dta"
drop _m
...
use "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\Long_Cuadrada_NoPanel.dta", clear
merge 1:m clave_mun year using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Longitudinal\20052009_Final_NoPanel_Claves_Comunes.dta"
keep if _merge !=2
drop _merge
...
merge m:m clave_mun year using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Base Presidentes\Muni_Presidentes_Desfasado.dta", gen(tt)
keep if tt ==3
drop tt
...
merge m:m clave_mun year using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Base Presidentes\Muni_Presidentes.dta", gen(tt) force
...
** homicides, gdp (state)
merge m:m codigo_estado year using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Censo\Homicides_State.dta", gen(m_aux2)
merge m:m codigo_estado year using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Censo\GDP_State.dta", gen(m_aux)

keep if inlist(year, 2005,2006,2007,2009,2010, 2011, 2012, 2013)

** election at the mun level dummy

merge m:1 clave_mun year using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Base Presidentes\mun_elec.dta", gen(xxxx) force

** homicides per capita (municipality)
merge m:1 clave_mun year using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Censo\Homicides_2005_2013_Poblacion.dta", gen(merg)
...
merge m:1 year clave_mun using  "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Base Presidentes\Partidos_Alianzas.dta", gen(merge_PD)
keep if year<2014 & year >2004
keep if merge_PD !=2
ren winner winner_D
merge m:1 year clave_mun using "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Base Presidentes\Partidos_Alianzas_Hecho.dta", gen(merge_P)
keep if year<2014 & year >2004
keep if merge_P !=2

** TAX COLLECTION DATA

merge m:1 clave_mun year using  "C:\Users\ghina\Downloads\118971-V1\Corruption_Final\Data\Censo\Taxes_mun_2006_2013.dta", gen(m_taxes)
keep if m_taxes!=2
drop m_taxes
...
*** ROBUSTNESS CHECK 1 ***
pca Romper NotReturn Robar Tranza Confiable
predict pc_11 pc_2 pc_3
gen PC =  pc_11  + pc_2 + pc_3
egen AA = min(PC)
egen BB=max(PC)
gen Diff=BB-AA
gen indexx=(factor_1-AA)/Diff
ren indexx TRES_1

*** ROBUSTNESS CHECK 2 ***
factor Romper NotReturn Robar Tranza Confiable
predict factor_1
egen AAA = min(factor_1)
egen BBB=max(factor_1)
gen DIF=BBB-AAA
gen INDEX=(factor_1-AAA)/DIF
ren INDEX TRES_2

*** Robustness Check-1
areg TRES_1 inter P_* PDE_* Time nivelultimo_* HOMI_CAP_MUN total mis_tot MismoPartido CorruptPast Corrupt Already TRABAJO_* ed_* yy_* , a(clave_mun) cluster(clave_mun)


*** Robustness Check-2
areg TRES_2 inter P_* PDE_* Time nivelultimo_* HOMI_CAP_MUN total mis_tot MismoPartido CorruptPast Corrupt Already TRABAJO_* ed_* yy_* , a(clave_mun) cluster(clave_mun)
